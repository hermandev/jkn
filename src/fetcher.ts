...
export interface SendOption {
  ...
  path:
    | `/${string}`
    | [`/${string}`, Record<string, string | number | undefined | null>];
...
export class Fetcher {
  ...
  public onRequest:
    | ((info: SendOption & { type: Type }) => MaybePromise<void>)
    | undefined = undefined;
  ...
  public onError: ((error: Error) => MaybePromise<void>) | undefined =
    undefined;
